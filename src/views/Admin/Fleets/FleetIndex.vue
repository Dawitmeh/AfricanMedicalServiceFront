    ...
    <AdminPageComponent>
        ...
        <div v-else class="grid sm:grid-cols-4 gap-4 mt-6">
            <div class="relative" v-for="fleet in fleets" :key="fleet.id">
                ...
                <router-link v-if="fleet?.id" :to="{name: 'AdminFleetView', params: {id: fleet.id}}" class="inline-flex float-right font-medium items-center text-theme-main hover:underline">
                    Detail
