                ...
                <tbody>
                    <tr v-for="(pack, index) in packages" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button class="ml-6 inline-flex font-medium items-center text-theme-main hover:underline">
                                Detail
                                <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778"/>
                                </svg>
                            </button>
                            <button @click="showDeleteModal(pack.id)" class="ml-6 inline-flex font-medium items-center text-red-600 hover:underline">
                                Remove
            ...
            <template #header>
                ...
                <div v-else class="text-center p-4">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                        Are you sure you want to delete this product package ?
                    </h3>
